...
export function factoryPomodoroTimer(
  pomodoroButtonId: string,
  timerMinutes: number
) {
...
export function factoryPomodoroTimerFromProjectTask(
...
export function factoryPomodoroTimerBreakTime(
  projectTask: ProjectTask,
  timerMinutes: number
) {
